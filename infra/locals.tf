locals {
  ...
  env_vars = {
    ...
    JWT_SECRET    = random_password.this.result
    ...
    POSTGRES_NAME = data.aws_caller_identity.this.id == "000000000000" ? "acme_incidents" : try(one(aws_rds_cluster.this.*.database_name), "")
